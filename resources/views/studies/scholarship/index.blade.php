                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select  class="form-control" disabled>
                                    <option disabled selected>{{auth()->user()->country->name}}</option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-4 mb-3">
                                <label for="university">الكلية</label>
                                <input value="{{$application->faculty}}" class="form-control" disabled>
                            </div>
                            <div class="col-md-4 mb-3">
